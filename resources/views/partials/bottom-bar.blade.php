...
<div class="fixed bottom-0 left-0 right-0 z-30 lg:hidden">
    <div class="border border-gray-300 py-3 flex gap-1 shadow-xl rounded-t-md bg-white mx-2 mb-2">
        <div class="group relative px-4 cursor-pointer flex-1">
            <a href="{{ route('dashboard') }}" class="flex h-10 w-full items-center justify-center rounded-full {{ request()->routeIs('dashboard') ? 'text-blue-500' : 'hover:text-blue-500' }}">
        ...
        <div class="group relative px-4 cursor-pointer flex-1">
            <a href="{{ route('bookings.index') }}" class="flex h-10 w-full items-center justify-center rounded-full {{ request()->routeIs('bookings.*') ? 'text-blue-500' : 'hover:text-blue-500' }}">
        ...
        <div class="group relative px-4 cursor-pointer flex-1">
            <a href="{{ route('customers.index') }}" class="flex h-10 w-full items-center justify-center rounded-full {{ request()->routeIs('customers.*') ? 'text-blue-500' : 'hover:text-blue-500' }}">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" height="24" width="24">
        ...
        <div class="group relative px-4 cursor-pointer flex-1">
            <button class="flex h-10 w-full items-center justify-center rounded-full hover:text-blue-500">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" height="24" width="24">
                    <g>
