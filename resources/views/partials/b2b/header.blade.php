    ...
    <div class="relative px-4 py-6">
        <div class="flex items-center justify-between mb-6">
            <div class="flex items-center space-x-3">
                ...
                <div>
                    <h1 class="text-xl font-bold text-slate-900">B2B Partner Management</h1>
                    <p class="text-sm text-slate-700">Manage your business partners</p>
                </div>
            </div>
            <button @click="openCreateModal()" class="soft-glass-card rounded-xl px-4 py-2 hover:bg-opacity-60 transition-all flex items-center">
        ...
        <div class="grid grid-cols-3 gap-4">
            <div class="glass-3d-card">
                <div class="glass-3d-content text-center">
                    <div class="text-2xl font-bold text-white" x-text="filteredPartners.filter(p => p.status === 'active').length"></div>
                    <div class="text-xs text-white opacity-80 uppercase tracking-wider">Active Partners</div>
                </div>
            </div>
            <div class="glass-3d-card">
                <div class="glass-3d-content text-center">
                    <div class="text-2xl font-bold text-white" x-text="filteredPartners.reduce((sum, p) => sum + p.reservations_count, 0)"></div>
                    <div class="text-xs text-white opacity-80 uppercase tracking-wider">Total Bookings</div>
                </div>
            </div>
            <div class="glass-3d-card">
                <div class="glass-3d-content text-center">
                    <div class="text-2xl font-bold text-white" x-text="filteredPartners.length"></div>
                    <div class="text-xs text-white opacity-80 uppercase tracking-wider">Total Partners</div>
                </div>
            </div>
        </div>
    </div>
