    ...
    <div class="divide-y divide-gray-100">
        <template x-for="booking in recentBookings" :key="booking.id">
            <div class="p-4 flex items-center space-x-3">
                ...
                <div class="flex-1">
                    <p class="text-sm font-medium text-gray-800" x-text="booking.guest ? booking.guest.name : 'Guest' + ' - ' + (booking.accommodation ? booking.accommodation.property.name : 'Property')"></p>
        ...
        <div x-show="recentBookings.length === 0" class="p-4 text-center text-gray-500">
