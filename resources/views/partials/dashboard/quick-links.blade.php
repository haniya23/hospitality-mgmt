<div class="bg-white rounded-2xl shadow-sm overflow-hidden">
    ...
    <div class="p-4 grid grid-cols-2 md:grid-cols-4 gap-4">
        ...
        <a href="{{ route('owner.tasks.index') }}" class="group flex flex-col items-center p-4 rounded-xl bg-gradient-to-br from-indigo-50 to-blue-50 hover:from-indigo-100 hover:to-blue-100 transition-all duration-300 transform hover:scale-105 border border-indigo-200">
            ...
            <span class="text-sm font-medium text-gray-800 text-center">Tasks</span>
        </a>
