...
<div class="bg-gradient-to-br from-white to-gray-50 rounded-xl shadow-md hover:shadow-lg border border-gray-200 p-4 sm:p-6 transition-shadow duration-300 mb-4">
    <div class="flex items-center justify-between">
        ...
        <div class="flex space-x-3">
            <button @click="exportCancelledBookings()" 
                    class="bg-gradient-to-r from-red-600 to-pink-600 text-white px-4 py-2 rounded-xl font-medium text-sm hover:from-red-700 hover:to-pink-700 transition-all duration-200 shadow-lg hover:shadow-xl transform hover:scale-105 flex items-center space-x-2">
    ...
    <div class="flex flex-col sm:flex-row gap-4">
        ...
        <div class="flex-1 relative">
            <input type="text" 
                   ...
                   class="w-full px-4 py-3 border-2 border-gray-200 rounded-xl focus:ring-2 focus:ring-red-500 focus:border-red-500 transition-all duration-200 bg-white hover:border-gray-300 font-semibold text-gray-800 pl-12">
