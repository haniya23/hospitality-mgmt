...
<div class="fixed top-0 left-0 right-0 z-40 bg-white/80 backdrop-blur-lg border-b border-gray-200/50 shadow-sm">
    <div class="flex items-center justify-between px-4 sm:px-6 py-3 sm:py-4">
        ...
        <div class="flex items-center space-x-3 sm:space-x-4">
            <button @click="sidebarOpen = !sidebarOpen" class="w-10 h-10 sm:w-11 sm:h-11 rounded-xl bg-gradient-to-br from-green-500 to-emerald-600 flex items-center justify-center hover:from-green-600 hover:to-emerald-700 transition-all duration-200 shadow-md hover:shadow-lg lg:hidden">
            ...
            <div>
                ...
                <p class="text-xs sm:text-sm text-gray-600 hidden sm:block">@yield('page-subtitle', 'Stay loops Management')</p>
            </div>
        </div>
