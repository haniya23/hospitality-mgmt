        ...
        <div class="grid grid-cols-2 gap-4">
            <div class="glass-3d-card">
                <div class="glass-3d-content text-center">
                    <div class="text-2xl font-bold text-white" x-text="rules.filter(r => r.status === 'active').length"></div>
                    <div class="text-xs text-white opacity-80 uppercase tracking-wider">Active Rules</div>
                </div>
            </div>
            <div class="glass-3d-card">
                <div class="glass-3d-content text-center">
                    <div class="text-2xl font-bold text-white" x-text="rules.length"></div>
                    <div class="text-xs text-white opacity-80 uppercase tracking-wider">Total Rules</div>
                </div>
            </div>
        </div>
    </div>
