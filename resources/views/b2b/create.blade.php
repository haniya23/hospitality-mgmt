            ...
            <div class="mb-8">
                ...
                <div class="flex flex-col items-center">
                    <div class="w-full max-w-md mb-6">
                        <label for="partner_name" class="block text-sm font-semibold text-gray-700 mb-2 flex items-center justify-center gap-2">
                    ...
                    <div class="w-full max-w-md">
                        <label for="partner_type" class="block text-sm font-semibold text-gray-700 mb-2 flex items-center justify-center gap-2">
                            <svg class="w-4 h-4 text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
