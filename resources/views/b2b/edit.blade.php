...
@section('title', 'Edit B2B Partner')
...
<div class="max-w-2xl mx-auto">
    <div class="bg-white rounded-2xl shadow-sm border border-gray-200 p-6 sm:p-8">
        <div class="mb-6">
            <h2 class="text-2xl font-bold text-gray-900">Edit B2B Partner</h2>
            <p class="text-gray-600 mt-1">Update partner information and settings</p>
        </div>

        <form action="{{ route('b2b.update', $b2b) }}" method="POST" class="space-y-6">
            @csrf
            @method('PUT')
            ...
            <div class="space-y-4">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div>
                        ...
                        <input type="text" id="partner_name" name="partner_name" value="{{ old('partner_name', $b2b->partner_name) }}" 
                    ...
                    <div>
                        ...
                        <select id="partner_type" name="partner_type" 
                            ...
                            <option value="Corporate" {{ old('partner_type', $b2b->partner_type) == 'Corporate' ? 'selected' : '' }}>Corporate</option>
                            <option value="Hotel Chain" {{ old('partner_type', $b2b->partner_type) == 'Hotel Chain' ? 'selected' : '' }}>Hotel Chain</option>
                            <option value="Tour Operator" {{ old('partner_type', $b2b->partner_type) == 'Tour Operator' ? 'selected' : '' }}>Tour Operator</option>
                        </select>
                        @error('partner_type')
                            <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                        @enderror
            ...
            <div class="space-y-4">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div>
                        ...
                        <input type="text" id="contact_person" name="contact_person" value="{{ old('contact_person', $b2b->contactUser->name) }}" 
                    ...
                    <div>
                        ...
                        <input type="tel" id="mobile_number" name="mobile_number" value="{{ old('mobile_number', $b2b->contactUser->mobile_number) }}" 
                ...
                <div>
                    ...
                    <input type="email" id="email" name="email" value="{{ old('email', $b2b->contactUser->email) }}" 
            ...
            <div class="space-y-4">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div>
                        ...
                        <input type="number" id="commission_rate" name="commission_rate" value="{{ old('commission_rate', $b2b->commission_rate) }}" 
                    ...
                    <div>
                        ...
                        <input type="number" id="default_discount_pct" name="default_discount_pct" value="{{ old('default_discount_pct', $b2b->default_discount_pct) }}" 
                               min="0" max="100" step="0.01"
            ...
            <!-- Status -->
            <div class="space-y-4">
                <h3 class="text-lg font-semibold text-gray-900 border-b border-gray-200 pb-2">Status</h3>
                ...
                <div>
                    ...
                    <select id="status" name="status" 
                        ...
                        <option value="suspended" {{ old('status', $b2b->status) == 'suspended' ? 'selected' : '' }}>Suspended</option>
                    </select>
                    @error('status')
                        <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                    @enderror
                    ...
                    <div class="ml-3">
                        ...
                        <div class="mt-2 text-sm text-blue-700">
                            <ul class="list-disc list-inside space-y-1">
                                <li>Reserved customer name will be automatically updated if partner name changes</li>
                                <li>Contact user information will be updated accordingly</li>
                                <li>Status changes will affect partner access and visibility</li>
                            </ul>
                        </div>
                    </div>
                </div>
