...
@section('content')
    <div class="max-w-7xl mx-auto py-6">
        ...
        <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4 mb-6">
            <div>
                <h1 class="text-2xl font-bold text-gray-900">Weekly Financial Reports</h1>
                <p class="text-gray-600">View and manage weekly financial summaries</p>
            </div>
                        ...
                        @empty
                            <tr>
                                <td colspan="7" class="px-6 py-12 text-center text-gray-500">
                                    ...
                                    <p class="mt-2 text-lg font-medium">No weekly reports yet</p>
                                    <p class="mt-1">Weekly reports are automatically generated every Monday.</p>
                                </td>
                            </tr>
                        @endforelse
                    </tbody>
