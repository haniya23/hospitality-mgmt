...
<div class="min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-50">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div class="modern-card rounded-2xl p-4 sm:p-6 mb-6">
            <form method="GET" action="{{ route('owner.leave-requests.index') }}" class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                <div>
        ...
        <div class="modern-card rounded-2xl overflow-hidden">
            ...
            <div class="text-center py-12">
                ...
                <p class="text-gray-500">No leave requests found for the selected filters.</p>
            </div>
            @endif
        </div>
    </div>
        ...
        <div class="bg-white rounded-2xl shadow-xl max-w-md w-full mx-4">
            ...
            <form id="approveForm" class="p-6">
                ...
                <div class="mb-4">
                    ...
                    <textarea name="notes" rows="3" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500" placeholder="Add any notes about the approval..."></textarea>
                </div>
        ...
        <div class="bg-white rounded-2xl shadow-xl max-w-md w-full mx-4">
            ...
            <form id="rejectForm" class="p-6">
                ...
                <div class="mb-4">
                    ...
                    <textarea name="rejection_reason" rows="3" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500" placeholder="Please provide a reason for rejection..." required></textarea>
                </div>
                <div class="flex justify-end space-x-3">
