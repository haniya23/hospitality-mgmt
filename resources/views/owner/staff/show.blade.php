...
<x-page-header 
    ...
    <div class="flex items-center justify-between mb-4">
        ...
        <a href="{{ route('owner.staff.edit', $staffAssignment->uuid) }}" 
           class="inline-flex items-center px-4 py-2 bg-gradient-to-r from-orange-600 to-red-600 text-white rounded-lg hover:from-orange-700 hover:to-red-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-orange-500 transition-all duration-200 transform hover:scale-105 font-medium">
