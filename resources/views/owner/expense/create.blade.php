...
@section('content')
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        ...
        <form method="POST" action="{{ route('owner.expense.store') }}" class="space-y-4 sm:space-y-6">
            @csrf
            ...
            <div
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-5">
                    ...
                    <div>
                        ...
                        @error('expense_category_id')<p class="text-red-500 text-sm mt-2 flex items-center gap-1"><svg
                            class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                d="M12 8v4m0 4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                        </svg>{{ $message }}</p>@enderror
                ...
                <div class="mt-5">
                    ...
                    @error('title')<p class="text-red-500 text-sm mt-2 flex items-center gap-1"><svg class="w-4 h-4"
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-5">
                    ...
                    <div>
                        <label for="vendor_name"
                            ...
                            Vendor Name <span class="text-gray-400 font-normal">(Optional)</span>
                        </label>
                    ...
                    <div>
                        <label for="receipt_number"
                            ...
                            Receipt Number <span class="text-gray-400 font-normal">(Optional)</span>
                        </label>
            ...
            <div class="bg-gradient-to-br from-white to-gray-50 rounded-xl shadow-md hover:shadow-lg border border-gray-200 p-4 sm:p-6 transition-shadow duration-300"
                ...
                <div class="flex items-center justify-between">
                    <div class="flex items-center gap-2">
                        ...
                        <h3
                            class="text-lg sm:text-xl font-bold bg-gradient-to-r from-amber-600 to-orange-600 bg-clip-text text-transparent">
                            Recurring Expense</h3>
                    </div>

                    <label class="flex items-center gap-3 cursor-pointer group">
                        <input type="checkbox" name="is_recurring" value="1" x-model="isRecurring"
                            class="h-5 w-5 text-amber-600 border-2 border-gray-300 rounded-lg focus:ring-2 focus:ring-amber-500 focus:ring-offset-2 transition-all duration-200">
                        <span
                            class="text-sm font-semibold text-gray-700 group-hover:text-amber-600 transition-colors">Enable</span>
                    </label>
                </div>

                <div x-show="isRecurring" x-transition
                    class="mt-5 grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-5 p-4 bg-amber-50 rounded-xl border border-amber-200">
                    <div>
                        <label for="recurring_frequency"
                            class="block text-sm font-semibold text-gray-700 mb-2">Frequency</label>
                        <select name="recurring_frequency" id="recurring_frequency"
                            class="w-full px-4 py-3 border-2 border-gray-200 rounded-xl focus:ring-2 focus:ring-amber-500 focus:border-amber-500 transition-all duration-200 bg-white hover:border-gray-300 font-semibold text-gray-800">
                    ...
                    <div>
                        <label for="recurring_end_date" class="block text-sm font-semibold text-gray-700 mb-2">End
                            Date</label>
            ...
            <div class="flex flex-col sm:flex-row justify-end space-y-3 sm:space-y-0 sm:space-x-4 pb-20 lg:pb-8">
                ...
                <button type="submit"
                    class="w-full sm:w-auto px-6 py-3 bg-gradient-to-r from-red-500 to-rose-600 text-white rounded-xl hover:from-red-600 hover:to-rose-700 transition-all shadow-lg font-semibold">
                    Save Expense
                </button>
            </div>
        </form>
