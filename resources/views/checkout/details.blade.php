        ...
        <div class="bg-white rounded-lg shadow-sm border border-gray-200 mb-4 sm:mb-6">
            <div class="px-4 sm:px-6 py-4 border-b border-gray-200">
                <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between space-y-3 sm:space-y-0">
                    <div>
                        <h1 class="text-xl sm:text-2xl font-bold text-gray-900">🚪 Check-out Details</h1>
                    ...
                    <div class="text-left sm:text-right">
                        ...
                        <div class="font-mono text-base sm:text-lg font-semibold text-blue-600">{{ $checkOut->uuid }}</div>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="p-4 sm:p-6">
                ...
                <div class="mb-4">
                    ...
                    <div class="flex flex-wrap items-center gap-1 sm:gap-2">
                        @for($i = 1; $i <= 5; $i++)
                        <svg class="w-5 h-5 sm:w-6 sm:h-6 {{ $i <= $checkOut->rating ? 'text-yellow-400' : 'text-gray-300' }}" fill="currentColor" viewBox="0 0 20 20">
