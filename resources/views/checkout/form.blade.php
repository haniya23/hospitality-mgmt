...
<div class="min-h-screen bg-gray-50 py-4 sm:py-8">
    <div class="max-w-4xl mx-auto px-3 sm:px-4 lg:px-8">
        ...
        <div class="bg-white rounded-lg shadow-sm border border-gray-200 mb-4 sm:mb-6">
            <div class="px-4 sm:px-6 py-4 border-b border-gray-200">
                <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between space-y-3 sm:space-y-0">
                    <div>
                        <h1 class="text-xl sm:text-2xl font-bold text-gray-900">🚪 Guest Check-Out</h1>
        ...
        <!-- Check-out Form -->
        <form action="{{ route('checkout.store', $reservation->uuid) }}" method="POST" class="space-y-4 sm:space-y-6">
            @csrf
                    ...
                    <div>
                        ...
                        <div class="flex flex-wrap gap-2 sm:gap-3">
                            ...
                            <label class="flex items-center">
                                ...
                                <svg class="w-5 h-5 sm:w-6 sm:h-6 text-yellow-400 ml-1" fill="currentColor" viewBox="0 0 20 20">
            ...
            <div class="flex flex-col sm:flex-row justify-end space-y-3 sm:space-y-0 sm:space-x-4 pb-16 sm:pb-20 lg:pb-8">
                ...
                <button type="submit" 
                        class="w-full sm:w-auto px-6 py-3 bg-green-600 text-white rounded-md hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-offset-2">
                    Complete Check-out
                </button>
            </div>
        </form>
