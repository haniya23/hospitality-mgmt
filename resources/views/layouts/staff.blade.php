...
<head>
    ...
    <title>@yield('title', 'Staff Dashboard') - Stay loops</title>
...
<body class="bg-gray-50" x-data="staffApp()">
    ...
    <div class="lg:ml-72 transition-all duration-300" :class="{ 'lg:ml-16': sidebarCollapsed }">
        ...
        <main class="px-4 pb-20 lg:pb-4">
            <!-- Staff Subscription Banner -->
            @include('components.staff-subscription-banner')
            
            @yield('content')
        </main>
    </div>
    
    @include('partials.staff-bottom-bar')
