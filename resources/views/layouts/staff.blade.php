...
<body class="bg-gradient-to-br from-blue-50 via-white to-purple-50 min-h-screen" x-data="staffApp()">
    ...
    <!-- Desktop Sidebar -->
    <div class="hidden lg:block fixed top-0 left-0 h-full w-80 bg-white shadow-2xl z-30">
        <div class="p-6">
            <!-- Sidebar Header -->
            ...
            <div class="mt-8 p-4 bg-gray-50 rounded-xl">
                ...
                <div class="grid grid-cols-2 gap-3">
                    ...
                    <div class="text-center">
                        <div class="text-lg font-bold text-green-600" x-text="stats.completedTasks"></div>
        ...
        <div class="relative px-4 py-4">
            <div class="flex items-center justify-between">
                ...
                <nav class="hidden md:flex items-center space-x-4">
                    ...
                    @if(Auth::user()->hasPermission('manage_guest_services') || Auth::user()->hasPermission('manage_checkin_checkout'))
                    <a href="{{ route('staff.guest-service.index') }}" class="soft-glass-card rounded-xl px-4 py-2 hover:bg-opacity-60 transition-all flex items-center {{ request()->routeIs('staff.guest-service.*') ? 'bg-opacity-80' : '' }}">
                        <i class="fas fa-concierge-bell text-indigo-500 mr-2"></i>
                        <span class="font-medium text-slate-800">Guest Service</span>
                    </a>
                    @endif
                </nav>
    ...
    <!-- Main Content -->
    <main class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 pb-20 lg:pb-6 lg:ml-80">
        @yield('content')
    </main>
